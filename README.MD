...
### Create Table and insert data to table if not exist
```
...
### Api Logout 
```
[POST]:localhost:9045/auth/logout
Request:
{
  "username":"errq"
}
...
```
[POST]:localhost:9045/account/create
{
    "firstname":"Ahmad",
    "lastname":"Farid",
    "address":"Cibanteng",
    "username":"errqs",
    "phoneNumber":"087786372117"
}
```
### Update
```
[POST]:localhost:9045/account/update
Request :
{
    "firstname":"Test",
    "lastname":"Update Acc",
...
### Delete
```
[POST]:localhost:9045/account/delete?id={id}

```
### Restore
```
[POST]:localhost:9045/account/restore?id={id}

```
### Get Account Pagin
```
[POST]:localhost:9045/account/get
...
```
[POST]:localhost:9045/transaction/create
{
    "productName":"DAIA",
...
### Update
```
[POST]:localhost:9045/transaction/update
Request :
{
    "productName":"DAIA",
    "productCategory":"Sabun",
...
### Delete
```
[POST]:localhost:9045/transaction/delete?id={id}

```
### Restore
```
[POST]:localhost:9045/transaction/restore?id={id}

```
### Get transaction Pagin
```
[POST]:localhost:9045/transaction/get
...
### Summary Transaction
```
[POST]:localhost:9045/transaction/summary
